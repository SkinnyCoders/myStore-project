<?php 
include '../controler/register_proc.php';
  ...
  <div class="register-box-body">
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="frmNama" placeholder="Nama Lengkap">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="frmRePassword" placeholder="Retype password">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input name="checkbox[]" id="agree" value="agree" type="checkbox"> saya setuju <a href="#">Peryaratan</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
...
<!--     <div class="social-auth-links text-center">
    ...
    <a href="login.php" class="text-center">Login, Jika sudah punya akun</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
